...
public class TypeTransaction implements Serializable {
    ...
    private String libelleTypeTransaction;
    
    public String getLibelleTypeTransaction() {
        return libelleTypeTransaction;
    }

    public void setLibelleTypeTransaction (String libelleTypeTransaction) {
    ...
    public String toString() {
        return "Entity.TypeTransaction[ id=" + id + " ]";
    }
