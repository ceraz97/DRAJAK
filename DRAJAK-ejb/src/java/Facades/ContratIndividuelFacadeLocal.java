...
public interface ContratIndividuelFacadeLocal {
    ...
    ContratIndividuel CreerContratIndividuel(String libelle, ChoixPaiement paiement, CompteAssure cleCompteAssure, PersonnePublique clePersonnePublique, CompteEmploye cleCompteEmploye, ContratIndividuel recupDevis);
