...
<html>
    ...
    <body>
         <script type="text/javascript">
            function getAjouterGarantie(id)  {
              var result = confirm("Voulez vous ajouter une nouvelle garantie ? Une rÈponse nÈgative entrainera la crÈation du module ");
                listeGarantie.push(id); 
                if(result)  {
        ...
        <div class="modal-content">
            <div class="modal-body">
                    ...
                    <div class="col-md-3">
                        ...
                        <c:forEach items="${requestScope.listeGarantie}" var="elementModules">
                         <div>
