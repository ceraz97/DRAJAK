<%-- 
    ...
    Created on : 10 mars 2020, 14:40:56
    Author     : Ilkayk
--%>
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                    <div class="col-md-8 ftco-animate text-center">
                        <p class="breadcrumbs"><span class="mr-2"><a href="accueil.jsp">Accueil</a></span> <span>Particulier</span></p>
                        <h1 class="mb-3 bread">Particulier, <br>connectez-vous</h1>
                    </div>
                </div>
            </div>
        </div>
