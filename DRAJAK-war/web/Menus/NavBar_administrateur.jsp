<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" onclick="location.href = 'menuDrajak?action=accueilPublic'"><i class="flaticon-pharmacy"></i><span>Dr</span>ajak</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item cta"><a onclick="location.href = 'menuDrajak?action=Deconnexion&typeConnexion=AdministrateurMenu'" class="nav-link"><span>Se déconnecter</span></a></li>
            </ul>
        </div>
    </div>
</nav>
